...
"""TFX iris template pipeline definition.
...
def create_pipeline(
  ...
  """Implements the chicago iris pipeline with TFX."""
  ...
  pusher = Pusher(
      model=trainer.outputs['model'],
      # TODO(step 6): Uncomment here to use a result from Evaluator.
      # model_blessing=evaluator.outputs['blessing'],
      push_destination=pusher_pb2.PushDestination(
          filesystem=pusher_pb2.PushDestination.Filesystem(
              base_directory=serving_model_dir)))  # pylint: disable=unused-variable
