...
from tfx.experimental.templates.iris.pipeline import configs
from tfx.experimental.templates.iris.pipeline import pipeline
...
DATA_PATH = 'gs://{}/tfx-template/data/iris/'.format(configs.GCS_BUCKET_NAME)
