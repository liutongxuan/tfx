...
"""TODO(muyangy): DO NOT SUBMIT without one-line documentation for resolver_operator.

TODO(muyangy): DO NOT SUBMIT without a detailed description of
resolver_operator.
"""
...
class BaseResolverOperator(six.with_metaclass(abc.ABCMeta, object)):
